...
<head>
  ...
  <link rel="shortcut icon" type="image/png" href="<?= base_url('assets/frontend/assets/images/logos/favicon.png') ?>" />
  <link rel="stylesheet" href="<?= base_url('assets/frontend/assets/css/styles.min.css')?>" />
</head>
...
<body>
    ...
    <div class="app-topstrip bg-dark py-6 px-3 w-100 d-lg-flex align-items-center justify-content-between">
      <div class="d-flex align-items-center justify-content-center gap-5 mb-2 mb-lg-0">
        <a class="d-flex justify-content-center" href="#">
          <img src="<?= base_url('assets/frontend/assets/images/logos/logo-wrappixel.svg')?>" alt="" width="150">
        </a>
      ...
      <div>
        <div class="brand-logo d-flex align-items-center justify-content-between">
          <a href="./index.html" class="text-nowrap logo-img">
            <img src="<?= base_url('assets/frontend/assets/images/logos/logo.svg')?>" alt="" />
          </a>
            ...
            <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link " href="javascript:void(0)" id="drop2" data-bs-toggle="dropdown"
                  aria-expanded="false">
                  <img src="<?= base_url('assets/frontend/assets/images/profile/user-1.jpg')?>" alt="" width="35" height="35" class="rounded-circle">
                </a>
                    ...
                    <table class="table mb-0 text-nowrap varient-table align-middle fs-3">
                      ...
                      <tbody>
                        <tr>
                          <td class="px-0">
                            <div class="d-flex align-items-center">
                              <img src="<?= base_url('assets/frontend/assets/images/profile/user-3.jpg')?>" class="rounded-circle" width="40"
                                alt="flexy" />
                              <div class="ms-3">
                        ...
                        <tr>
                          <td class="px-0">
                            <div class="d-flex align-items-center">
                              <img src="<?= base_url('assets/frontend/assets/images/profile/user-5.jpg')?>" class="rounded-circle" width="40"
                                alt="flexy" />
                              <div class="ms-3">
                        ...
                        <tr>
                          <td class="px-0">
                            <div class="d-flex align-items-center">
                              <img src="<?= base_url('assets/frontend/assets/images/profile/user-6.jpg')?>" class="rounded-circle" width="40"
                                alt="flexy" />
                              <div class="ms-3">
                                <h6 class="mb-0 fw-bolder">
                                  Christopher Jamil
                        ...
                        <tr>
                          <td class="px-0">
                            <div class="d-flex align-items-center">
                              <img src="<?= base_url('assets/frontend/assets/images/profile/user-7.jpg')?>" class="rounded-circle" width="40"
                                alt="flexy" />
                              <div class="ms-3">
                        ...
                        <tr>
                          <td class="px-0">
                            <div class="d-flex align-items-center">
                              <img src="<?= base_url('assets/frontend/assets/images/profile/user-8.jpg')?>" class="rounded-circle" width="40"
                                alt="flexy" />
                              <div class="ms-3">
              ...
              <div class="card">
                ...
                <div class="comment-widgets scrollable mb-2 common-widget" style="height: 465px" data-simplebar="">
                  ...
                  <div class="d-flex flex-row comment-row border-bottom p-3 gap-3">
                    <div>
                      <span><img src="<?= base_url('assets/frontend/assets/images/profile/user-3.jpg')?>" class="rounded-circle" alt="user"
                          width="50" /></span>
                    </div>
                  ...
                  <div class="d-flex flex-row comment-row border-bottom active p-3 gap-3">
                    <div>
                      <span><img src="<?= base_url('assets/frontend/assets/images/profile/user-5.jpg')?>" class="rounded-circle" alt="user"
                          width="50" /></span>
                    </div>
                  ...
                  <div class="d-flex flex-row comment-row border-bottom p-3 gap-3">
                    <div>
                      <span><img src="<?= base_url('assets/frontend/assets/images/profile/user-6.jpg')?>" class="rounded-circle" alt="user"
                          width="50" /></span>
                    </div>
                    <div class="comment-text w-100">
                  ...
                  <div class="d-flex flex-row comment-row p-3 gap-3">
                    <div>
                      <span><img src="<?= base_url('assets/frontend/assets/images/profile/user-4.jpg')?>" class="rounded-circle" alt="user"
                          width="50" /></span>
                    </div>
                    <div class="comment-text w-100">
                      <h6 class="fw-medium">James Anderson</h6>
  ...
  <script src="<?= base_url('assets/frontend/assets/libs/jquery/dist/jquery.min.js')?>"></script>
  <script src="<?= base_url('assets/frontend/assets/libs/bootstrap/dist/js/bootstrap.bundle.min.js')?>"></script>
  <script src="<?= base_url('assets/frontend/assets/js/sidebarmenu.js')?>"></script>
  <script src="<?= base_url('assets/frontend/assets/js/app.min.js')?>"></script>
  <script src="<?= base_url('assets/frontend/assets/libs/apexcharts/dist/apexcharts.min.js')?>"></script>
  <script src="<?= base_url('assets/frontend/assets/libs/simplebar/dist/simplebar.js')?>"></script>
  <script src="<?= base_url('assets/frontend/assets/js/dashboard.js')?>"></script>
  <!-- solar icons -->
